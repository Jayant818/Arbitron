...
import { ARBITRON_PROGRAM_ADDRESS, fetchMaybeContest, fetchMaybeParticipent } from "../../../../dist/js-client";
    ...
    useEffect(() => {
        ...
        async function checkAuthorizationAndStatus() {
            try {
                ...
                const contestInfo = await fetchMaybeContest(rpc, address(contestId as string))
