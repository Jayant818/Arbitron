...
import { Plus, DollarSign, Target, CalendarIcon, ArrowLeft, Sparkles, Trophy, Settings } from "lucide-react"
      ...
      <header className="border-b border-border/50 backdrop-blur-xl sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-display font-bold neon-text-teal tracking-wider">CREATE CONTEST</h1>
          </div>
